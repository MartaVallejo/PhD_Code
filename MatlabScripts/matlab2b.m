list = dir('../../../Documents/PhD/CollectedData/Scenarios/Scenario 14');
isub = [list(:).isdir]; %# returns logical vector
nameFolds = {list(isub).name}'; % return name folders in scenario

cd('../../../Documents/PhD/CollectedData/Scenarios/Scenario 14');
