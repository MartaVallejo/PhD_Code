...
public class Municipality {
	...
	//Green areas protected in one tick
	...
	public void selectGreenAreas(int currentTick){
		...
		try{
			...
			case 0:
				...
				if(currentTick==0){
					System.out.println("Tick of the system: " + currentTick + " Acc budget: 0" +
							" budget now:" + this.budget[currentTick]);
					this.accumulateBudget[currentTick] = lattice.searchGreenSpaceS(this.budget[currentTick], currentTick);
				}else{
					System.out.println("Tick of the system: " + currentTick + " Acc budget:" + this.accumulateBudget[currentTick-1] +
						" budget now:" + this.budget[currentTick]);
					this.accumulateBudget[currentTick] = lattice.searchGreenSpaceS(this.budget[currentTick] + this.accumulateBudget[currentTick-1], currentTick);
				}
				break;
			case 1:
				...
				if(currentTick==0){
					System.out.println("Tick of the system: " + currentTick + " Acc budget: 0" +
							" budget now:" + this.budget[currentTick]);
					this.accumulateBudget[currentTick] = lattice.searchGreenSpaceP(this.budget[currentTick], currentTick);
				}else{
					System.out.println("Tick of the system: " + currentTick + " Acc budget:" + this.accumulateBudget[currentTick-1] +
						" budget now:" + this.budget[currentTick]);
					this.accumulateBudget[currentTick] = lattice.searchGreenSpaceP(this.budget[currentTick] + this.accumulateBudget[currentTick-1], currentTick);
				}
				break;
			}
