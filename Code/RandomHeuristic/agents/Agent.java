...
public class Agent{
	...
	protected int age;
	/**
	 * The green satisfaction of the agent
	 */
	protected int greenSatisfaction;
	
	private int minGreenDistance;
	...
	public int getGreenSatisfaction(){
		this.minGreenDistance = lattice.distanceTo(this.location, CellState.PROTECTED);
		
		if(minGreenDistance > 3 || minGreenDistance==0){
			this.greenSatisfaction = 0;
		}else{
			this.greenSatisfaction = 4 - minGreenDistance;
		}
		return greenSatisfaction;
	}
	...
	public int getMinGreenDistance(){
		return this.minGreenDistance;
	}
}
