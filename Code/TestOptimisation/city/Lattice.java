...
public class Lattice {
	...
	public static String NUM_STATISTICS;
	public static String TYPE_FITNESS;
	public static String GA_ID;
	public static String TYPE_SELECTION;
	public static String TYPE_SATISFACTION_TICKS;
	public static String TYPE_SATISFACTION_AGENTS;
	public static String PERCENTAGE_STOCHASTIC;
	...
	public void searchGreenSpace(int tick, Municipality municipality){
		this.greenArea.searchGreenSpace(tick, municipality);
	}
	...
	public int getInconsistency(){
		return this.greenArea.getInconsistency();
	}
	
	public int getLackBudget(){
		return this.greenArea.getLackBudget();
	}
	...
	public String getCBDStrint(){
		if(Lattice.CBDS.length==1){
			return "[" + Lattice.CBDS[0] + "]";
		}else{
			return "[" + Lattice.CBDS[0] + "-" + Lattice.CBDS[1] + "]";
		}
	}
}
